...
$('#btnAdicionarPedidoAdicionarProduto').click(function () {
    ...
    if (validarPreenchimento('#formIncluirPedido #divPedidoAdicionarProduto')) {
        ...
        produto.Codigo = +$('#ddlPedidoProduto').siblings('.es-list').find('.es-visible').attr('value');

        if ($('#ddlPedidoTabelaPreco').val() == '') {
        ...
        requisicaoAjax('Pedido/ConsultarProduto?codigoProduto=' + produto.Codigo + '&numeroProdutoCliente=' + produto.NumeroProdutoCliente, null, function (retorno) {
            ...
            if (retorno.Entity.Codigo == 0) {
                ...
                produto.CodigoTipoTamanho = $('#ddlPedidoTipoTamanho').siblings('.es-list').find('.es-visible').attr('value');
                produto.DescricaoTipoTamanho = $('#ddlPedidoTipoTamanho').val();
                produto.CodigoTipoCor = $('#ddlPedidoProdutoTipoCor').siblings('.es-list').find('.es-visible').attr('value');
                produto.DescricaoTipoCor = $('#ddlPedidoProdutoTipoCor').val();
