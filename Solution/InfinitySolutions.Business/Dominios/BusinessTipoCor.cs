...
namespace InfinitySolutions.Business
{
    ...
    public class BusinessTipoCor : BusinessBase
    {
        #region AÇÕES
        ...
        public Retorno Excluir(TipoCor Entity)
        {
            try
            {
                return new DataTipoCor().Excluir(Entity);
            }
            catch (Exception ex)
            {
                return Retorno.CriarRetornoExcecao(ex);
        ...
        public Retorno Listar(int Pagina, int QntPagina)
        {
            try
            {
                return new DataTipoCor().Listar(Pagina, QntPagina);
            }
            catch (Exception ex)
            {
                return Retorno.CriarRetornoExcecao(ex);
